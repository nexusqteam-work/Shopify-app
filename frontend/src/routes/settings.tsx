    ...
    <div className="mx-auto w-full max-w-[1100px] 2xl:max-w-[1280px] px-4 sm:px-6 lg:px-10 xl:px-14 py-6 lg:py-8 xl:py-10">
      ...
      <div className="space-y-4">
        <Section
          ...
          description="Your Shopify store is connected and syncing in real time."
          delay={60}
        >
          <div
        ...
        <Section
          icon={Bell}
          title="Notifications"
          description="Choose when StoreCoach should alert you."
          delay={120}
        >
        ...
        <Section
          icon={Sparkles}
          title="AI Advisor"
          description="Fine-tune how the AI uses your store context."
          delay={180}
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Section
            icon={Lock}
            title="Security"
            description="2-factor authentication and access controls."
            delay={240}
          >
          ...
          <Section
            icon={CreditCard}
            title="Billing"
            description="StoreCoach Pro · ₹2,499 / month."
            delay={280}
          >
