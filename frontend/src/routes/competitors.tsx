    ...
    <div className="mx-auto w-full max-w-[1440px] 2xl:max-w-[1720px] px-4 sm:px-6 lg:px-10 xl:px-14 py-6 lg:py-8 xl:py-10">
      ...
      <div className="space-y-4 mb-6">
            ...
            <div key={competitor.name} className="surface-card p-6 animate-fade-up" style={{ animationDelay: `${i * 80}ms` }}>
              <div className="flex items-start justify-between mb-5">
                <div>
                  <div className="flex items-center gap-3">
                    <h2 className="display text-[18px] font-bold tracking-tight">{competitor.name}</h2>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[13px] leading-relaxed">{competitor.insight}</p>
                </div>
              </div>
            </div>
          );
        ...
        {competitors.length === 0 && (
          <div className="surface-card p-8 text-[13px]" style={{ color: "var(--text-secondary)" }}>
            No competitors tracked yet. Add one from the backend to populate this page.
          </div>
        )}
      </div>
    </div>
